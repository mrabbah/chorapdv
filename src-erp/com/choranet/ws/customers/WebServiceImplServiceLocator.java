...
public class WebServiceImplServiceLocator extends org.apache.axis.client.Service implements com.choranet.ws.customers.WebServiceImplService {
    ...
    private java.lang.String WebService_address = "http://localhost:8180/choranet/services/WebService";
    ...
    public com.choranet.ws.customers.WebServiceImpl getWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.choranet.ws.customers.WebServiceSoapBindingStub _stub = new com.choranet.ws.customers.WebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.choranet.ws.customers.WebServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.choranet.ws.customers.WebServiceSoapBindingStub _stub = new com.choranet.ws.customers.WebServiceSoapBindingStub(new java.net.URL(WebService_address), this);
                _stub.setPortName(getWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8180/choranet/services/WebService", "WebServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8180/choranet/services/WebService", "WebService"));
        }
