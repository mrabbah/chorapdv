...
public class JMessageDialog extends javax.swing.JDialog {
     ...
     * @return
     */
    public static JMessageDialog getMessage(Component parent, MessageInf inf) {
    ...
    public static JMessageDialog getMessageLicense(Component parent, String messageLicenseTitle) {
        MessageInf inf = new MessageInf(MessageInf.SGN_IMPORTANT,
                            LocalRes.getIntString(messageLicenseTitle),
                            LocalRes.getIntString("message.chora.contact.information"));
        JMessageDialog MsgDialog = getMessage(parent, inf);
        MsgDialog.setTitle(LocalRes.getIntString("title.message.license"));
        MsgDialog.setLocation(410, 400);
        MsgDialog.setSize(450, 120);
