...
/**
048	 * \brief Additional help to handle serial connect / disconnect, and registering
049	 *        interrupt handler
050	 */
public class SerialHelper {
    ...
    protected void setSerialPortParameters() throws IOException {
        ...
        final int baudRate = 9600; // 57600bps
    ...
    public static void InitCommunication(String portName) {
        SerialHelper serialHelper = new SerialHelper();
        try {
            serialHelper.connect(portName);
            serialHelper.disconnect();
        } catch (Exception e) {
            System.err.println(e.getMessage());
            System.out.println("rxtxSerial.dll file must be in jre\bin java path");
        }
//            checkListSerialPorts(serialHelper);
//            checkAddDataAvailableListener(serialHelper, portName);
...
//                System.exit(1);
//            }
            InitCommunication("COM1");

//            SerialHelper serialHelper = new SerialHelper();
//            checkListSerialPorts(serialHelper);
//            serialHelper.connect("COM1");
//            checkAddDataAvailableListener(serialHelper, "COM1");
//            serialHelper.disconnect();
        }
