...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Administrator role', $FILE{/com/choranet/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Manager role', $FILE{/com/choranet/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Employee role', $FILE{/com/choranet/pos/templates/Role.Employee.xml} );
--INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Guest role', $FILE{/com/choranet/pos/templates/Role.Guest.xml} );
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('0', 'Printer.Start', 0, $FILE{/com/choranet/pos/templates/Printer.Start.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('1', 'Printer.Ticket', 0, $FILE{/com/choranet/pos/templates/Printer.Ticket.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('2', 'Printer.Ticket2', 0, $FILE{/com/choranet/pos/templates/Printer.Ticket2.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('3', 'Printer.TicketPreview', 0, $FILE{/com/choranet/pos/templates/Printer.TicketPreview.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('4', 'Printer.TicketTotal', 0, $FILE{/com/choranet/pos/templates/Printer.TicketTotal.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('5', 'Printer.OpenDrawer', 0, $FILE{/com/choranet/pos/templates/Printer.OpenDrawer.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('6', 'Printer.Ticket.Logo', 1, $FILE{/com/choranet/pos/templates/Printer.Ticket.Logo.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('7', 'Printer.TicketLine', 0, $FILE{/com/choranet/pos/templates/Printer.TicketLine.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('8', 'Printer.CloseCash', 0, $FILE{/com/choranet/pos/templates/Printer.CloseCash.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('9', 'Window.Logo', 1, $FILE{/com/choranet/pos/templates/Window.Logo.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('10', 'Window.Title', 0, $FILE{/com/choranet/pos/templates/Window.Title.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('11', 'Ticket.Buttons', 0, $FILE{/com/choranet/pos/templates/Ticket.Buttons.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('12', 'Ticket.Line', 0, $FILE{/com/choranet/pos/templates/Ticket.Line.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('13', 'Printer.Inventory', 0, $FILE{/com/choranet/pos/templates/Printer.Inventory.xml});
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'cinquante_dirhams', 1, $FILE{/com/choranet/pos/templates/cinquante_dirhams.png});
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('31', 'poweredby.logo', 1, $FILE{/com/choranet/pos/templates/poweredby.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('32', 'Chora.Biglogo', 1, $FILE{/com/choranet/pos/templates/Biglogo.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('33', 'usedby_logo', 1, $FILE{/com/choranet/pos/templates/chora_icon.PNG});
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Restaurant floor', $FILE{/com/choranet/pos/templates/restaurantsample.png});
...
CREATE TABLE `useref` (
  `keydd` varchar(40) NOT NULL,
  `hostname` varchar(20) DEFAULT NULL,
  `refclient` varchar(20) DEFAULT NULL,
  `date` datetime DEFAULT NULL,
  `isfirstacess` tinyint(1) DEFAULT NULL,
  `isDemo` tinyint(1) NOT NULL,
  `nbrProdAllowed` int(11) DEFAULT NULL,
  PRIMARY KEY (`keydd`),
  UNIQUE KEY `keydd` (`keydd`),
  UNIQUE KEY `isfirstacess` (`isfirstacess`),
  UNIQUE KEY `date` (`date`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

### For specific devise use :
# INSERT INTO `useref` (`keydd`, `hostname`, `refclient`, `date`, `isfirstacess`, `isDemo`, `nbrProdAllowed`)
#    VALUES('DEVISE_NAME','','','0000-00-00 00:00:00',1,0,0);