...
import com.choranet.pos.util.BarcodeGenerator;
...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    public ProductsEditor(DataLogicSales dlSales, DirtyManager dirty) {
        ...
        m_CodetypeModel.add(CodeType.EAN8);
    ...
    private void m_jCodeActionPerformed(java.awt.event.ActionEvent evt) {
       String newCode = BarcodeGenerator.getEANKey(m_jCode.getText());
        m_jCode.setText(newCode);
    }
