...
import com.choranet.beans.*;
import com.choranet.data.gui.*;
...
import com.choranet.pos.printer.TicketParser;
import com.choranet.pos.printer.TicketPrinterException;
import com.choranet.pos.scanpal2.DeviceScanner;
import com.choranet.pos.scanpal2.DeviceScannerException;
import com.choranet.pos.scanpal2.ProductDownloaded;
...
public class StockManagement extends JPanel implements JPanelView {
    ...
    public StockManagement(AppView app) {
        ...
        m_App = app;
        m_dlSystem = (DataLogicSystem) m_App.getBean("com.choranet.pos.forms.DataLogicSystemCreate");
    ...
    private void initComponents() {
        ...
        jNumberKeys = new com.choranet.beans.JNumberKeys();
        ...
        jNumberKeys.addJNumberEventListener(new com.choranet.beans.JNumberEventListener() {
        ...
        m_jbtndate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/date.png"))); // NOI18N
    ...
    private void jNumberKeysKeyPerformed(com.choranet.beans.JNumberEvent evt) {//GEN-FIRST:event_jNumberKeysKeyPerformed
    ...
    private com.choranet.beans.JNumberKeys jNumberKeys;
