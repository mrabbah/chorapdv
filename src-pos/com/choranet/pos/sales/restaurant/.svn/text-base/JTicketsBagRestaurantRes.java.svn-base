...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    public JTicketsBagRestaurantRes(AppView oApp, JTicketsBagRestaurantMap restaurantmap) {
        ...
        dlCustomers = (DataLogicCustomers) oApp.getBean("com.choranet.pos.customers.DataLogicCustomersCreate");
    ...
    private void initComponents() {
        ...
        m_jtxtDescription = new com.choranet.editor.JEditorString();
        m_jtxtChairs = new com.choranet.editor.JEditorIntegerPositive();
        txtCustomer = new com.choranet.editor.JEditorString();
        ...
        m_jbtnTables.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/atlantikdesignersmall.png"))); // NOI18N
        ...
        m_jbtnReceive.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/mime.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/kuser.png"))); // NOI18N
    ...
    private com.choranet.editor.JEditorIntegerPositive m_jtxtChairs;
    private com.choranet.editor.JEditorString m_jtxtDescription;
    private com.choranet.editor.JEditorString txtCustomer;
