...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private TicketLineInfo init(AppView app, TicketLineInfo oLine) {
        ...
        m_jName.setEnabled(m_oLine.getProductID() == null && app.getAppUserView().getUser().hasPermission("com.choranet.pos.sales.JPanelTicketEdits"));
        m_jPrice.setEnabled(app.getAppUserView().getUser().hasPermission("com.choranet.pos.sales.JPanelTicketEdits"));
        m_jPriceTax.setEnabled(app.getAppUserView().getUser().hasPermission("com.choranet.pos.sales.JPanelTicketEdits"));
    ...
    private void initComponents() {
        ...
        m_jName = new com.choranet.editor.JEditorString();
        m_jUnits = new com.choranet.editor.JEditorDouble();
        m_jPrice = new com.choranet.editor.JEditorCurrency();
        m_jPriceTax = new com.choranet.editor.JEditorCurrency();
        ...
        m_jButtonOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/button_ok.png")));
        ...
        m_jButtonCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/button_cancel.png")));
    ...
    private com.choranet.editor.JEditorString m_jName;
    private com.choranet.editor.JEditorCurrency m_jPrice;
    private com.choranet.editor.JEditorCurrency m_jPriceTax;
    private javax.swing.JLabel m_jSubtotal;
    private javax.swing.JLabel m_jTaxrate;
    private javax.swing.JLabel m_jTotal;
    private com.choranet.editor.JEditorDouble m_jUnits;
