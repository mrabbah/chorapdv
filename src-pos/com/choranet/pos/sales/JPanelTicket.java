...
import com.choranet.pos.scale.ScaleException;
import com.choranet.pos.payment.JPaymentSelect;
import com.choranet.basic.BasicException;
import com.choranet.data.gui.ListKeyed;
...
import com.choranet.pos.payment.JPaymentSelectReceipt;
import com.choranet.pos.payment.JPaymentSelectRefund;
...
import com.choranet.pos.util.JRPrinterAWT300;
...
//    private ScriptObject scriptobjinst;
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        m_App = app;
        dlSystem = (DataLogicSystem) m_App.getBean("com.choranet.pos.forms.DataLogicSystemCreate");
        dlSales = (DataLogicSales) m_App.getBean("com.choranet.pos.forms.DataLogicSalesCreate");
        dlCustomers = (DataLogicCustomers) m_App.getBean("com.choranet.pos.customers.DataLogicCustomersCreate");
    ...
    private void printPartialTotals(){
        ...
        if (m_oTicket.getLinesCount() == 0) {
            ...
            m_jSubtotalEuros.setText(m_oTicket.printSubTotalWithoutTax());
            m_jTaxesEuros.setText(m_oTicket.printTaxWithoutTax());
            m_jTotalEuros.setText(m_oTicket.printTotalWithoutTax());
        }
    }
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jNumberKeys = new com.choranet.beans.JNumberKeys();
        ...
        btnSplit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/editcut.png"))); // NOI18N
        ...
        m_jbtnScale.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/ark216.png"))); // NOI18N
        ...
        m_jUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/1uparrow22.png"))); // NOI18N
        ...
        m_jDown.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/1downarrow22.png"))); // NOI18N
        ...
        m_jDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/locationbar_erase.png"))); // NOI18N
        ...
        m_jList.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/search22.png"))); // NOI18N
        ...
        m_jEditLine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/color_line.png"))); // NOI18N
        ...
        m_jNumberKeys.addJNumberEventListener(new com.choranet.beans.JNumberEventListener() {
            public void keyPerformed(com.choranet.beans.JNumberEvent evt) {
        ...
        m_jEnter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/barcode.png"))); // NOI18N
    ...
    private void m_jNumberKeysKeyPerformed(com.choranet.beans.JNumberEvent evt) {//GEN-FIRST:event_m_jNumberKeysKeyPerformed
    ...
    private com.choranet.beans.JNumberKeys m_jNumberKeys;
