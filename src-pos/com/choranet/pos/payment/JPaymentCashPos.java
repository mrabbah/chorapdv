...
public class JPaymentCashPos extends javax.swing.JPanel implements JPaymentInterface {
    ...
    public class ScriptPaymentCash {
        ...
        public ScriptPaymentCash(DataLogicSystem dlSystem) {
            ...
            tnbbutton = new ThumbNailBuilder(64, 54, "com/choranet/images/cash.png");
        }
    ...
    private void initComponents() {
        ...
        m_jTendered = new com.choranet.editor.JEditorCurrencyPositive();
    ...
    private com.choranet.editor.JEditorCurrencyPositive m_jTendered;
