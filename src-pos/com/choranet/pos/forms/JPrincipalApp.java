...
import java.util.*;
import javax.swing.*;
import com.choranet.beans.RoundedBorder;
...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
    ...
    public JPrincipalApp(JRootApp appview, AppUser appuser) {
        ...
        m_dlSystem = (DataLogicSystem) m_appview.getBean("com.choranet.pos.forms.DataLogicSystemCreate");
...
//        m_principalnotificator.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("TextField.shadow")), javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 5)));        
        ...
        if (jButton1.getComponentOrientation().isLeftToRight()) {
            menu_open = new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/menu-right.png"));
            menu_close = new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/menu-left.png"));
        } else {
            menu_open = new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/menu-left.png"));
            menu_close = new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/menu-right.png"));
        }
...
//            taskGroup = new JTaskPaneGroup();
        ...
        public void addChangePasswordAction() {            
            addAction(new ChangePasswordAction("/com/choranet/images/yast_security.png", "Menu.ChangePassword"));
        }       
        public void addExitAction() {            
            addAction(new ExitAction("/com/choranet/images/gohome.png", "Menu.Exit"));
        }
...
//        public JTaskPaneGroup getTaskGroup() {
    ...
    public class ScriptSubmenu {
        ...
        public void addChangePasswordAction() {            
            menudef.addMenuItem(new ChangePasswordAction("/com/choranet/images/yast_security.png", "Menu.ChangePassword"));
        }        
        public void addExitAction() {
            menudef.addMenuItem(new ExitAction("/com/choranet/images/gohome.png", "Menu.Exit"));
        }
