...
import com.choranet.data.loader.BatchSentence;
import com.choranet.data.loader.BatchSentenceResource;
...
import com.choranet.pos.scanpal2.DeviceScannerFactory;
...
public class JRootApp extends JPanel implements AppView {
    ...
    private SecurityDataLogicSystem m_dlSystem;

    public SecurityDataLogicSystem getM_dlSystem() {
        return m_dlSystem;
    }

    public AppProperties getM_props() {
        return m_props;
    }
    ...
    public boolean initApp(AppProperties props) {
        ...
        try {
            ...
            JMessageDialog.showMessage(this, new MessageInf(MessageInf.SGN_DANGER, e.getMessage(), null));
            return false;
        }

        m_dlSystem = (SecurityDataLogicSystem) getBean("com.choranet.pos.forms.DataLogicSystemCreate");
        ...
        m_jLblTitle.setText(m_dlSystem.getResourceAsText("Window.Title"));  
          ...
          //
        BufferedImage poweredbylogo = m_dlSystem.getResourceAsImage("poweredby.logo");
        poweredby.setIcon(imgicon == null ? null : new ImageIcon(poweredbylogo));

        //
        BufferedImage biglogo = m_dlSystem.getResourceAsImage("Chora.BigLogo");
        jLabel1.setIcon(imgicon == null ? null : new ImageIcon(biglogo));
        ...
        m_jHost.setText("<html>" + m_props.getHost() + " - " + sWareHouse);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center>CHORA POS le système de gestion des points de vente conçu pour écran tactil.<br>" +
            "Copyright \u00A9 2010-2011 CHORA INFORMATIQUE, SARL.<br>" +
            "http://www.choranet.com<br>" +
            "<br>" +
            "</center>");
        ...
        m_jClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/exit.png"))); // NOI18N
        ...
        m_jHost.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/display.png"))); // NOI18N
