...
import com.choranet.pos.printer.escpos.*;
import com.choranet.pos.printer.javapos.DeviceDisplayJavaPOS;
import com.choranet.pos.printer.javapos.DeviceFiscalPrinterJavaPOS;
import com.choranet.pos.printer.javapos.DevicePrinterJavaPOS;
import com.choranet.pos.printer.printer.*;
import com.choranet.pos.printer.screen.*;

import com.choranet.pos.util.SerialHelper;
...
public class DeviceTicket {
   ...
   private static Logger logger = Logger.getLogger("com.choranet.pos.printer.DeviceTicket");
        ...
        public PrinterWritter getPrinterWritter(String con, String port) throws TicketPrinterException {
            ...
            if (pw == null) {
                if ("serial".equals(con) || "rxtx".equals(con)) {
                    ...
                    SerialHelper.InitCommunication(port);
