...
public class TicketInfo implements SerializableRead, Externalizable {
    ...
    public String printSubTotalWithoutTax() {
        return Formats.CURRENCY.formatValue(new Double(getSubTotal())/1.2);
    }
    public String printTaxWithoutTax() {
        return Formats.CURRENCY.formatValue(new Double((getSubTotal())/1.2)*0.2);
    }
    public String printTotalWithoutTax() {
        return Formats.CURRENCY.formatValue(new Double(getSubTotal()));
    }
