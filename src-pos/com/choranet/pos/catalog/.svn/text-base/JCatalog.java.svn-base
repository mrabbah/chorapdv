...
public class JCatalog extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    public JCatalog(DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int width, int height) {
        ...
        tnbcat = new ThumbNailBuilder(32, 32, "com/choranet/images/folder_yellow.png");
        tnbbutton = new ThumbNailBuilder(width, height, "com/choranet/images/package.png");
    }
    ...
    private void initComponents() {
        ...
        m_btnBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/3uparrow.png"))); // NOI18N
        ...
        m_btnBack1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/choranet/images/3uparrow2.png"))); // NOI18N
